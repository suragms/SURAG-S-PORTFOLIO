  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        I craft modern, intelligent, and user-focused web applications using React.js, Django, and Python. 
        I'm passionate about building clean, scalable code, designing intuitive interfaces, and solving real-world problems through smart, data-driven solutions. Whether it's a finance tracker or an AI-powered health app, I aim to turn ideas into impactful digital experiences.
        </p>
