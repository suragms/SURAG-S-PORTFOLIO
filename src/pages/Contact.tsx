                  ...
                  <div className="p-6 flex flex-col items-center">
                    ...
                    <div className="mb-4">
                      ...
                      <p className="text-white/90 text-sm mb-2">
                        Full Stack Developer | AI/ML Enthusiast | Founder – Stress Detection for IT Professionals | PG MCA – University of Calicut (First Class with Distinction, CGPA 8.21) | Python • Django • React • scikit-learn • Rasa
                      </p>
                      ...
                      <div className="flex items-center text-white/70 text-sm mb-4">
                        ...
                        <span>University of Calicut — MCA (First Class with Distinction, CGPA 8.21) — CCSIT Thalikullam</span>
                      </div>
                    </div>
